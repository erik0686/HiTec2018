$( document ).ready(function() {
  ...
  $("#jueves").click(function() {
      $("#tablebody").empty();
      $("#tablebody").append("<tr>");
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #98bf13;">8:30 h</td>');
      ...
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #98bf13;">9:00 h</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Bienvenida</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Campus</td>');
      $("#tablebody").append('</tr><tr>');
      ...
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Pasillo DAF</td>');
      $("#tablebody").append('</tr><tr>');
      ...
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Centro Estudiantil</td>');
      $("#tablebody").append('</tr><tr>');
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #98bf13;">14:00 h</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Rally</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Campus</td>');
      $("#tablebody").append('</tr><tr>');
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #98bf13;">16:00 h</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Been Tec Done That</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Gimnasio</td>');
      $("#tablebody").append('</tr><tr>');
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #98bf13;">17:30 h</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Team Back</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #98bf13;">Campus</td>');
      $("#tablebody").append('</tr><tr>');
      $("#tablebody").append('<td scope="row" >18:00 h</td>');
      $("#tablebody").append('<td>Cierre</td>');
      $("#tablebody").append('<td>Campus</td>');
      $("#tablebody").append('</tr>');
  });
  ...
  $( "#viernes" ).click(function() {
    $("#tablebody").empty();
      $("#tablebody").append("<tr>");
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #ed8943;">8:30 h</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Bienvenida</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Centro Estudiantil</td>');
      $("#tablebody").append('</tr><tr>');
      ...
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Campus</td>');
      $("#tablebody").append('</tr><tr>');
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #ed8943;">12:30 h</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Plática David Garza</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Gimnasio</td>');
      $("#tablebody").append('</tr><tr>');
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #ed8943;">14:00 h</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Comida</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Centro Estudiantil</td>');
      $("#tablebody").append('</tr><tr>');
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #ed8943;">15:00 h</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Tienes Que Vivirlo</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Campus</td>');
      $("#tablebody").append('</tr><tr>');
      $("#tablebody").append('<td scope="row" style="border-bottom: 0.1rem solid #ed8943;">17:00 h</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Plática Dirección de Carrera</td>');
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Salones Varios</td>');
      $("#tablebody").append('</tr><tr>');
      ...
      $("#tablebody").append('<td style="border-bottom: 0.1rem solid #ed8943;">Jardín de las Carreras</td>');
      $("#tablebody").append('</tr>');
  });
});
